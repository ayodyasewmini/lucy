...
<head>
    ...
    <style>
        ...
        .card {
            ...
            margin-bottom: 30px; /* Adds spacing between cards */
        }
...
<main class="container mt-5">
    <h2 class="text-center mb-4">Gifts Delivery</h2>
    <div class="row">
        <?php
        // Fetch products from the database
        $result = $conn->query("SELECT * FROM products WHERE category='gifts_delivery'");
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<button class='btn btn-primary' onclick='orderNow(\"{$row['name']}\")'>Order Now</button>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
        }
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="footer-logo">
                    <img src="photos/logo2.png" alt="Logo" style="height: 40px;"> Flower Shop
                </div>
