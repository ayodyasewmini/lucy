...
<head>
    ...
    <title>Graduation Flowers</title>
...
<main class="container mt-5">
    <h2 class="text-center mb-4">Graduation Flowers</h2>
    <div class="row">
    <?php
        // Fetch products from the database
        $result = $conn->query("SELECT * FROM products WHERE category='graduation'");
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 footer-section footer-links">
                <h5>Links</h5>
